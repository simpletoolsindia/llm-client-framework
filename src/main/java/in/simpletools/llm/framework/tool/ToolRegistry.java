...
public class ToolRegistry {
    ...
    public static class ToolInfo {
        ...
        public ToolInfo(String name, String description, Map<String, ParamInfo> params,
                       Function<Map<String, Object>, Object> handler, Method method, Object instance) {
            this.name = name; this.description = description; this.params = params;
            this.handler = handler; this.method = method; this.instance = instance;
        }
    ...
    public void register(String name, String description, Function<Map<String, Object>, Object> handler, Map<String, ParamInfo> params) {
